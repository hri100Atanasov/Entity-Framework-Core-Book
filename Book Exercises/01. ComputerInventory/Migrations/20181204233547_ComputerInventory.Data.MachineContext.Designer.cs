...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.Machine", b =>
                {
                    ...
                    b.Property<string>("InstalledRolls")
                        .IsRequired()
                        .HasMaxLength(50)
                        .IsUnicode(false);
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.MachineType", b =>
                {
                    b.Property<int>("MachineTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MachineTypeID")
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.MachineWarranty", b =>
                {
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.OperatingSys", b =>
                {
                    b.Property<int>("OperatingSysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("OperatingSysID")
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.SupportLog", b =>
                {
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.SupportTicket", b =>
                {
                    b.Property<int>("SupportTicketId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("SupportTicketID")
                    ...
                    b.Property<string>("TicketOpendBy")
                        .IsRequired()
                        .HasMaxLength(50)
                        .IsUnicode(false);
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.WarrantyProvider", b =>
                {
                    b.Property<int>("WarrantyProviderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("WarrantyProviderID")
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.Machine", b =>
                {
                    b.HasOne("_01._ComputerInventory.Models.MachineType", "MachineType")
                        .WithMany("Machine")
                        .HasForeignKey("MachineTypeId")
                        .HasConstraintName("FK_MachineType");

                    b.HasOne("_01._ComputerInventory.Models.OperatingSys", "OperatingSys")
                        .WithMany("Machine")
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.MachineWarranty", b =>
                {
                    b.HasOne("_01._ComputerInventory.Models.WarrantyProvider", "WarrantyProvider")
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.SupportLog", b =>
                {
                    b.HasOne("_01._ComputerInventory.Models.SupportTicket", "SupportTicket")
                        .WithMany("SupportLog")
            ...
            modelBuilder.Entity("_01._ComputerInventory.Models.SupportTicket", b =>
                {
                    b.HasOne("_01._ComputerInventory.Models.Machine", "Machine")
