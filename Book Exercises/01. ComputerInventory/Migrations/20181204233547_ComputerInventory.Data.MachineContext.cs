        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstalledRolls = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    OperatingSysID = table.Column<int>(nullable: false),
                    MachineTypeID = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketOpendBy = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    MachineID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
